    ...
    <footer className="border-t border-white/10 bg-black font-sans text-white">
      <div className="page-shell py-12 sm:py-16">
        <div className="grid gap-10 border-b border-white/12 pb-10 md:grid-cols-[1fr_auto] md:items-end">
          <div>
            <a href="#top" className="text-2xl font-semibold tracking-[-0.04em] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white uppercase">{siteConfig.name}</a>
